...
#define WHITE 0xFFFF
#define SKY tft->color565(0, 251, 255)
#define PINK tft->color565(255, 0, 200)
#define ORANGE tft->color565(255, 128, 0)

uint16_t color_slide[] = { 0xF800, 0xFAA0, 0xFF80, 0xBFE0, 0x07E0, 0x07F5, 0x07DF, 0x05BF, 0x033F, 0x481F, 0xF81E, 0xF811, 0xF80B,
                           0xF811, 0x07DF00, 0xFF, 0xF811, 0x481F };

uint16_t color[] = { 0xF800, 0xFAA0, 0xFF80, 0xBFE0, 0x07E0, 0x07F5, 0x07DF, 0x05BF, 0x033F, 0x481F, 0xF81E, 0xF811, 0xF80B,
                     0xF811, 0x07DF00, 0xFF, 0xF811, 0x481F };
